        ...
        <div class="card border-0 shadow-sm rounded-3">
            ...
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-0">
                ...
                <h5 class="fw-bold m-0 text-success">
                    📈 Statistik Pelayanan & Peternakan
                </h5>

                <small class="text-muted">
                    <i class="bi bi-arrow-repeat me-1"></i>
                    Otomatis ganti tiap 5 dtk
                </small>
        ...
        <div class="card border-0 shadow-sm rounded-3 h-100">
            ...
            <div class="card-body">
                ...
                <p class="text-secondary small">
                    Selamat datang di sistem pelayanan terpadu.
                    Gunakan menu sidebar untuk navigasi data populasi,
                    penerbitan dokumen pelayanan peternakan,
                    serta manajemen master data.
                </p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var dataPenyakit =
        {{ json_encode(array_map('intval', $dataPenyakit ?? [])) }};
    ...
    var chartPopulasi = new ApexCharts(
        document.querySelector("#chartPopulasi"),
        {
            chart: {
                type: 'bar',
                height: 260
    ...
    var chartSkkh = new ApexCharts(
        document.querySelector("#chartSkkh"),
        {
            chart: {
                type: 'line',
                height: 260
    ...
    var chartIb = new ApexCharts(
        document.querySelector("#chartIb"),
        {
            chart: {
                type: 'pie',
                height: 260,
    ...
    var chartPenyakit = new ApexCharts(
        document.querySelector("#chartPenyakit"),
        {
            chart: {
                type: 'bar',
                height: 260
    ...
    var carouselEl =
        document.getElementById('dashboardCarousel');
